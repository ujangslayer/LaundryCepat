<x-admin-layout>
    ...
    <div class="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm mb-6 flex flex-col sm:flex-row gap-4 items-center justify-between">
        <div class="relative w-full sm:w-96">
            <i class="fa-solid fa-search absolute left-4 top-1/2 -translate-y-1/2 text-gray-400"></i>
            <input type="text" placeholder="Cari nama, email, atau telepon..." class="w-full pl-11 pr-4 py-3 bg-gray-50 border border-transparent focus:border-blue-200 focus:bg-white rounded-xl outline-none transition text-sm font-medium">
        </div>
        <div class="flex items-center gap-3 w-full sm:w-auto">
            <select class="bg-gray-50 border-none text-sm font-bold text-gray-700 rounded-xl py-3 px-4 focus:ring-2 focus:ring-blue-500 outline-none w-full sm:w-auto">
                <option value="">Urutkan: Terbaru</option>
                <option value="">Urutkan: Terlama</option>
                <option value="">Pesanan Terbanyak</option>
            </select>
        </div>
    </div>
                    ...
                    <tr class="hover:bg-gray-50/50 transition">
                        ...
                        <td class="px-8 py-5 text-center">
                            <div class="inline-flex flex-col items-center justify-center">
                                <span class="text-lg font-black text-[#0A58CA]">{{ $customer->pesanan->count() }}</span>
